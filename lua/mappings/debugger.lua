...
local file_extension = vim.fn.expand("%"):match("%.(.*)")

map("n", "<F5>", file_extension == "rs" and "<cmd>RustLsp debug<cr>" or dap.continue, { desc = "start" })
map(
	"n",
	"<leader>dc",
	file_extension == "rs" and "<cmd>RustLsp debug<cr>" or dap.continue,
